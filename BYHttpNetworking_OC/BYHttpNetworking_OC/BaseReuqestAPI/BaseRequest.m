...
NSString * const NetworkDomain = @"https://httpbin.org";
...
////        DLog(@"Request %@ failed, status code = %ld, error = %@", NSStringFromClass([request class]), (long)request.responseStatusCode, error.localizedDescription);
//}
                      ...
                      error:(NSError *)error
{
    ...
    DLog(@"%@", [NSString stringWithFormat:@"HTTP状态码:%ld-->状态码描述：%@", statusCode, status_str]);
#endif
#endif
